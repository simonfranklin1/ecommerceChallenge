...
/* Imagens mobile */
    ...
    const btnPrev = window.document.querySelector('#previous');
    const btnNext = window.document.querySelector('#next');
...
/* Cart */
    ...
    const cartIcon = window.document.querySelector("#cart-icon");
